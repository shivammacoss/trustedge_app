...
const styles = StyleSheet.create({
  ...
  accountOptionActive: { backgroundColor: '#5a189a20' },
  ...
  closeBtn: { backgroundColor: '#5a189a20', paddingVertical: 10, borderRadius: 8, alignItems: 'center' },
  closeBtnText: { color: '#5a189a', fontSize: 13, fontWeight: '600' },
